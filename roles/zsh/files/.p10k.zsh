# Generated by Powerlevel10k configuration wizard on 2019-10-09 at 12:01 EEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_PATH_SEPARATOR="%F{red} $(print_icon 'LEFT_SUBSEGMENT_SEPARATOR') %F{black}"
  ...
  POWERLEVEL9K_USER_FOREGROUND=180
  POWERLEVEL9K_USER_BACKGROUND=124
